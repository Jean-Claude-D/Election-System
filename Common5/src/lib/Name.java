...
/**
 * Name Class represents by 2 String, firstName and lastName. Both firstName and lastName must be at
 * least 2 characters long, and cannot be null. Only hyphen, apostrophe and white-space are
 * alllowed, but they must be between 2 letters
 * 
...
public class Name implements Serializable, Comparable<Name> {
  ...
  /**
   * Constructs an object before create Name object, the Constructor calls the validate method to
  ...
  /**
   * Return the String representation of firstName follows by an empty space, follow by last name.
   * E.g. John Smith. of Name Object.
   * 
   * @return firstNam.
   */
  ...
  /**
   * Validate to see if a string is valid or not. The algorithm of the check is: Only letter and 3
   * special characters are allow: hyphen, apostrophe and white space. And these 3 special
   * characters must be between 2 letters. This algorithm is applied for both first name and last
   * name.
   * 
  ...
  private String validate(String name) {
    ...
    if ((!Character.isLetter(name.charAt(0)))) {
      throw new IllegalArgumentException(
          "Not a Valid Name, first character \'" + name.charAt(0) + "\' must be a letter");
    }
    // Check for the last character of the string must be a letter.
    if ((!Character.isLetter(name.charAt(name.length() - 1)))) {
      throw new IllegalArgumentException(
          "Not a Valid Name, first character \'" + (name.charAt(0) - 1) + "\' must be a letter");
    }
  ...
  /**
   * Return a String representation of firstName follows by an "*", follow by last name. E.g.
   * John*Smith
   * 
   * @return firstName*lastName
   */
   ...
   * 
   * @return 0 if two Name are equal, a positive integer if current Name is greater than the passed
   *         in Name, a negative if vice versa.
  ...
  /**
   * Check if an Object is equal to a Name or not. A note for this method: If 2 Objects are equal,
  ...
  /**
   * Return the hascode from the getFullName of Name A note for this method: If 2 Objects are equal,
   * they MUST have the same hashcode
   * 
