...
public class EmailTest {
  ...
  public static void testGetterMethod(String a) {
    ...
    System.out.println((email7.getAddress().equals(a))
        ? "The email is: " + email7.getAddress() + "\t\t\t\t === TEST PASSED ==="
        : "TEST FAILED");
    System.out.println((email7.getUserId().equals(email7.getUserId()))
        ? "The userID is: " + email7.getUserId() + "\t\t\t\t === TEST PASSED ==="
        : "TEST FAILED");
    System.out.println((email7.getHost().equals(email7.getHost()))
        ? "The hostID is: " + email7.getHost() + "\t\t\t\t === TEST PASSED ==="
        : "TEST FAILED");
    System.out.println("------------------------------");
    System.out.println();
  ...
  public static void testEqualsAndHashcode(String a, String b) {
    ...
    if (!email2.equals(email1) && (email2.hashCode() != email1.hashCode())) {
      System.out
          .println("Email2 is NOT \"equal\" to Email1, hence they DO NOT have the same hashcode ");
      System.out.println("\t\t\t\t\t\t\t === TEST PASSED ===");
      System.out.println();
    } else {
      System.out.println("TEST FAILED");
    ...
    if (email2.equals(email2Copy) && (email2.hashCode() == email2Copy.hashCode())) {
      System.out
          .println("email2 is \"equal\" to copyEmail2, hence they DO NOT have the same hashcode ");
      System.out.println("\t\t\t\t\t\t\t === TEST PASSED ===");
      System.out.println();
    } else {
      System.out.println("TEST FAILED");
