...
public class AddressTest {
	...
	private static void TheNoParameterConstructor(String testCase, boolean expectValid) {
		...
		try {
			...
			int expectZero = theAddress.getCivicNumber().length() + theAddress.getStreetName().length()
					+ theAddress.getCity().length();
			if (expectZero == 0)
	...
	private static void testTheThreeParameterConstructor() {
		...
		testTheThreeParameterConstructor("Case 3 - Invalid data – twospaces  civicNumber ( Sherbrooke Westmount)", "  ",
				"Sherbrooke", "Westmount", false);
		testTheThreeParameterConstructor("Case 4 - Invalid data – empty streetName ( Sherbrooke Westmount)", "3040",
				" ", "Westmount", false);
		testTheThreeParameterConstructor("Case 5 - Invalid data – twospaces streetName ( Sherbrooke Westmount)", "3040",
				"  ", "Westmount", false);
		testTheThreeParameterConstructor("Case 6 - Invalid data – empty city ( Sherbrooke Westmount)", "3040",
				"Sherbrooke", "", false);
		testTheThreeParameterConstructor("Case 7 - Invalid data – twospaces city ( Sherbrooke Westmount)", "3040",
				"Sherbrooke", "  ", false);
		testTheThreeParameterConstructor("Case 8 - Invalid data – null civicNumber (null Sherbrooke Westmount)", null,
				"Sherbrooke", "Westmount", false);
		testTheThreeParameterConstructor("Case 9 - Invalid data – null streetName (null Sherbrooke Westmount)", "3040",
	...
	private static void testSetCivicNumber() {
		...
		testSetCivicNumber("Case 3: Valid - 2086 with trailing spaces", "2086 ", "2086", true);
		testSetCivicNumber("Case 4: Valid - 2086 with leading spaces", " 2086", "2086", true);
		testSetCivicNumber("Case 5: Invalid - twospaces civic number", "  ", "", false);
