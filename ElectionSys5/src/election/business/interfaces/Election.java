...
public interface Election extends Serializable, Comparable<Election> {
  ...
  /**
   * Gets the postal code start range, if applicable. Returns null if not applicable.
   * 
  ...
  /**
   * Gets the postal code end range, if applicable. Returns null if not applicable.
   * 
  ...
  /**
   * Sets the Tally object. Used when reading data that is persisted to file, for example when the
   * voting takes place over multiple days.
   * 
  ...
  /**
   * Casts a Ballot with the BallotItem values set as needed. If valid, the Tally is incremented.
   * 
   * @param b
   * @param v
   */
