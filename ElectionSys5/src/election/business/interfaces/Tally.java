...
public interface Tally extends Serializable {
  ...
  /**
   * Returns a 2d array where the rows represent each Ballot Item and the columns represent the
   * ranking (0 to number of Ballot Items -1). Note that in the case of a Single election, only the
