...
public interface Ballot extends Serializable, Comparable<Ballot> {
  ...
  /**
   * Ballot can be cast by a voter. The voter parameter is required since eventually we need to
   * verify that the voter is not fraudulent (i.e., not eligible to vote, or has already voted.
   * 
   * @param voter
   */
  ...
  /**
   * Returns a deep copy of the BallotItems that make up the Ballot. Used to Tally the vote.
   * 
